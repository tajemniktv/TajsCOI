...
namespace TajsCOI.Tests
{
    public sealed class SettingsTests
    {
        ...
        {
            Assert.Equal(19, PerformanceSettingsCatalog.All.Count);
            Assert.Equal(19, PerformanceSettingsCatalog.All.Select(x => x.Key).Distinct(StringComparer.Ordinal).Count());
            Assert.All(
